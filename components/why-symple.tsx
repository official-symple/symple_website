        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col">
            <Image
              ...
              width={500}
              height={300}
              className="rounded-2xl object-cover w-full h-64 mb-8"
            />
            <div className="bg-teal-50 rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <strong>디지털 접근성:</strong> 스마트폰을 통해 언제 어디서나 멘탈케어 서비스에 접근할 수 있습니다.
                  </p>
                </li>
                <li className="flex items-start">
                  <span className="text-teal-500 mr-2">•</span>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-gray-100 rounded-full px-6 py-3">
            <p className="text-gray-700 font-medium">
              SYMPLE은 <span className="text-teal-600 font-bold">83%</span>의 사용자가 4주 사용 후
              <span className="text-teal-600 font-bold"> 정서적 안정감</span>을 느꼈다고 보고했습니다.
            </p>
          </div>
        </div>
      </div>
